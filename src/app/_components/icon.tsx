export default function Icon({
  ...
  const paths: Record<string, React.ReactNode> = {
    ...
    india: (
      <path d="M7.2 2.5 10 3.3l1.7 2.1 2.7-.3 1.3 2.2 2.8 1.2-1.1 2.2 1.4 2.3-2.1 1.6-.5 2.8-2.2 1.3-1.2 3.1-2.1-2.4-1.3-2.6-2.4-1.1.2-2.3-2-1.5 1.5-2.2-.7-2.3 2.2-1.3-.2-1.6Z" />
    ),
